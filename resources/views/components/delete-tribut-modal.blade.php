@props(['message' =>null,'id'=>null,'onclick'=>null])
<div class="modal fade cropImageModal show" id="delete-tribut-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="justify-content: space-between;" aria-modal="true">
                <div class="modal-dialog modal-dialog-centered" style=" max-width: 870px ;">
                    <div class="modal-content successModal" style="    height: 430px;">
                            <div class="d-flex " style="    padding-right: 22px;        flex-direction: row-reverse;">
                                     <button type="button" class="close-modal-custom tribut-modal pt-3 AuthantictionModal_close" data-dismiss="modal" aria-label="Close" style="cursor: pointer; background: unset;  border: transparent;">
                        ...
                        <div class="modal-body p-0 d-flex justify-content-center" style="     text-align: center;   align-items: center;">
                            <div class="d-flex align-items-center text-dark" style="flex-direction: column;"> 
                                ...
                                <p><span class="h2" style="color:#000000ab;">{{$message}}</span></p>
                               
                                      <button style="background-color: #456297;font-family: 'DM Serif Display';"  id="submit-btn" onclick="{{$onclick}}" class="btn rounded-3 mb-3 mt-2 text-white  py-2" type="submit">
